...
if ($result->num_rows > 0) {
    while($row = $result->fetch_assoc()) {
        ...
        echo "<div data-aos='fade-up' class='product__item mb-3'>";
        ...
        echo "<button class='btn btn__buynow' data-productid=".$row["product_id"]." data-toggle='modal' data-target='#cart'><span>Mua ngay</span></button>";
